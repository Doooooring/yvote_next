...
export const typeExplain = {
  ...
  청와대: `국민을 대표하여 행정부를 지휘하는 대통령은, 국무회의를 주재하여 국정 기조를 전달하고 정부 정책들을 최종적으로 승인합니다. 또한 대통령은 중요하다고 생각되는 사안에 대한 별도의 회의를 주재하기도 하며, 외교적으로는 우리나라를 대표하는 역할을 담당합니다. 청와대의 주요 인사로는 비서실장, 정책실장, 국가안보실장 및 수석비서관들이 있으며, 대통령은 이들과의 수석비서관회의를 통해 비공개로 자문을 구하고 지시사항을 전달하기도 합니다.`,
