    ...
    <Wrapper>
      ...
      <Body>
        <EachValue>
          ...
          <p>
            &apos;정치 참여에 필요한 최소한의 뉴스&apos;를 목표로 두는 와이보트는, 여러분의 인생에서
            정치 뉴스를 읽는데에 필요한 노력을 최소화하고자 합니다.
          </p>
          <p>
            이를 위해 첫 번째, &apos;최소한의 정치 뉴스&apos;를 결정하는 독자적인 기준을 마련하고
            뉴스를 선정합니다. 모든 기준은 &apos;국민의 투표를 통해 바꿀 수 있는 내용인가&apos;를
            대원칙으로 삼고 있습니다.
          </p>
          <p>
        ...
        <EachValue>
          ...
          <p>
            ...
            기준부터 작성까지, 사람의 개입을 최소화하고 &apos;정보 전달&apos;이라는 뉴스의 본질을
            지키기 위해 노력합니다.
          </p>
        </EachValue>
        <VerticalLine />
