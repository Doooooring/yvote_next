...
export default function Privacy() {
  return (
    <Wrapper>
      <br />
      <br />
      <p>와이보트 서비스 개인정보처리방침</p>
      <p>
        {'<와이보트>'}('https://yvoting.com/'이하 '와이보트')은(는) 「개인정보 보호법」 제30조에
        따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록
        하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
      </p>
      <p>○ 이 개인정보처리방침은 2023년 8월 1일부터 적용됩니다.</p>
      <br />
      <p>제1조(개인정보의 처리 목적)</p>
      <p>
        {'<와이보트>'}('https://yvoting.com/'이하 '와이보트')은(는) 다음의 목적을 위하여 개인정보를
      ...
      <p>
        ① {'<와이보트>'}은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를
      ...
      <p>① {'<와이보트>'}은(는) 다음의 개인정보 항목을 처리하고 있습니다.</p>
      <p>1{'< 홈페이지 회원가입 및 관리 >'}</p>
      <p>필수항목 : 이메일</p>
      <p>선택항목 :</p>
      <br />
      ...
      <p>
        ① {'<와이보트>'} 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게
      ...
      <p>1. 파기절차</p>
      <p>
        {'<와이보트>'} 은(는) 파기 사유가 발생한 개인정보를 선정하고, {'<와이보트>'} 의 개인정보
        보호책임자의 승인을 받아 개인정보를 파기합니다.
      </p>
      <br />
      <p>제5조(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)</p>
      <p>
        ① 정보주체는 {'<와이보트>'}에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의
        권리를 행사할 수 있습니다.
      </p>
      <p>
        ② 제1항에 따른 권리 행사는{'<와이보트>'}에 대해 「개인정보 보호법」 시행령 제41조제1항에
        따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 {'<와이보트>'}은(는) 이에 대해
        지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ {'<와이보트>'}은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구
        시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
      </p>
      <br />
      <p>제6조(개인정보의 안전성 확보조치에 관한 사항)</p>
      <p>{'<와이보트>'}은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
      <p>1. 정기적인 자체 감사 실시</p>
      <p>
      ...
      <p>
        {'<와이보트>'} 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를
        사용하지 않습니다.
      </p>
      <br />
      <p>제8조 (개인정보 보호책임자에 관한 사항)</p>
      <p>
        ① {'<와이보트>'} 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와
      ...
      <p>직급 :{'<공동대표>'}</p>
      <p>
        연락처 :{'<010-2081-6705>'}, {'<team.ddog1@gmail.com>'},
      </p>
      <p>※ 개인정보 보호 담당부서로 연결됩니다.</p>
      <p>▶ 개인정보 보호 담당부서</p>
      <p>부서명 :{'<개인정보 담당부서>'}</p>
      <p>담당자 :{'<감영진>'}</p>
      <p>연락처 :{'<010-2081-6705>, <team.ddog1@gmail.com>,'}</p>
      <p>
        ② 정보주체께서는 {'<와이보트>'} 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
        보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
        문의하실 수 있습니다. {'<개발자 심지훈 - 회사 이름>'} 은(는) 정보주체의 문의에 대해 지체
        없이 답변 및 처리해드릴 것입니다.
      </p>
      <br />
      ...
      <p>{'<와이보트>'}은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.</p>
